...
export declare type ScrollbarAppearance = 'standard' | 'compact';
export declare type ScrollbarTrack = 'vertical' | 'horizontal' | 'all';
export declare type ScrollbarVisibility = 'hover' | 'always' | 'native';
export declare type ScrollbarPosition = 'native' | 'invertY' | 'invertX' | 'invertAll';
export declare type ScrollbarPointerEventsMethod = 'viewport' | 'scrollbar';
export declare const NG_SCROLLBAR_OPTIONS: InjectionToken<Partial<IScrollbarOptions>>;
export declare type NgScrollbarOptions = Partial<IScrollbarOptions>;
/**
